...
set compilerFlags=-DDEBUG_BUILD=1 -Od -Oi -MTd -nologo -Z7 -Zo -fp:fast -Gm- -GR- -EHsc -EHa- -WX -W4 -wd4996 -wd4201 -wd4100 -wd4189 -wd4505 -wd4127 -wd4005 -FC
set linkerFlags=-opt:ref -incremental:no
set win_libs=gdi32.lib user32.lib winmm.lib d3dcompiler.lib d3d12.lib dxgi.lib dxguid.lib xinput.lib
